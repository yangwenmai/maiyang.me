...
从比赛一开始，导师团就非常积极和给力，直接来到我们项目组，给予直接指导和建议，我们找导师也非常的配合，在整个 hackathon 期间，导师帮助我们确定课题方向和目标，以及在热点数据上多次给予直接指导和解决实际问题（包括两次代码级别的调整），非常感谢他们，对照之下，我们的主动性和准备真的很不足，值得反思。
